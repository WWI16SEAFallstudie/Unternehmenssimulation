	    	...
	    	<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					<div id="marketingCompany" class="card card-aktive">
						...
						<ul class="list-group">
							<li class="list-group-item" onclick="marketing('marketingCompany0',1);">Punkt 1 <a class="addBtn">+ ${ mCC0} &euro;</a></li>
							<li class="list-group-item" onclick="marketing('marketingCompany1',1);">Punkt 2 <a class="addBtn">+ ${ mCC1} &euro;</a></li>
							<li class="list-group-item" onclick="marketing('marketingCompany2',1);">Punkt 3 <a class="addBtn">+ ${ mCC2} &euro;</a></li>
						</ul>
	      	...
	      	<div class="row">
				<div class="col-sm-4 col-md-4 col-lg-4">
					...
					<h4>Modell 1</h4>
					<ul class="list-group">
						<li class="list-group-item" onclick="marketing('marketing0Clock0',1);">Punkt 1 <a class="addBtn">+ ${ mCm00} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing1Clock0',1);">Punkt 2 <a class="addBtn">+ ${ mCm01} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing2Clock0',1);">Punkt 3 <a class="addBtn">+ ${ mCm02} &euro;</a></li>
					</ul>
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					...
					<h4>Modell 2</h4>
					<ul class="list-group">
						<li class="list-group-item" onclick="marketing('marketing0Clock1',1);">Punkt 1 <a class="addBtn">+ ${ mCm10} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing1Clock1',1);">Punkt 2 <a class="addBtn">+ ${ mCm11} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing2Clock1',1);">Punkt 3 <a class="addBtn">+ ${ mCm12} &euro;</a></li>
					</ul>
				...
				<div class="col-sm-4 col-md-4 col-lg-4">
					...
					<h4>Modell 3</h4>
					<ul class="list-group">
						<li class="list-group-item" onclick="marketing('marketing0Clock2',1);">Punkt 1 <a class="addBtn">+ ${ mCm20} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing1Clock2',1);">Punkt 2 <a class="addBtn">+ ${ mCm21} &euro;</a></li>
						<li class="list-group-item" onclick="marketing('marketing2Clock2',1);">Punkt 3 <a class="addBtn">+ ${ mCm22} &euro;</a></li>
					</ul>
