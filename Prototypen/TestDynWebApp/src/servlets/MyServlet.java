	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Auswahl der Sparte zu Spielbeginn
			...
			if (request.getParameter("selectoeko") != null) {
				...
				for(int i = 0; i < 3; i++){
					request.setAttribute("m0c"+i, Info.getGehaeuseOeko()[i]); // setzen der Bezeichnungen der Geh�use
					request.setAttribute("m0b"+i, Info.getArmbandOeko()[i]); // setzen der Bezeichnungen der Armb�nder
			...
			if (request.getParameter("selectluxus") != null) {
				...
				for(int i = 0; i < 3; i++){
					request.setAttribute("m0c"+i, Info.getGehaeusePremium()[i]); // setzen der Bezeichnungen der Geh�use
					request.setAttribute("m0b"+i, Info.getArmbandPremium()[i]); // setzen der Bezeichnungen der Armb�nder
			...
			if (request.getParameter("selectbillig") != null) {
				...
				for(int i = 0; i < 3; i++){
					request.setAttribute("m0c"+i, Info.getGehaeuseBillig()[i]); // setzen der Bezeichnungen der Geh�use
					request.setAttribute("m0b"+i, Info.getArmbandBillig()[i]); // setzen der Bezeichnungen der Armb�nder
					request.setAttribute("m0cw"+i, Info.getUhrwerkOeko()[i]); // setzen der Bezeichnungen der Uhrwerke
				}
							...
							if(spieler[spiel.getAktuellerSpieler()].getUhr()[i] != null){
								...
								switch(segment) {
									case "Billig":
										...
										for(int j = 0; j < 3; j++){
											request.setAttribute("m"+i+"c"+j, Info.getGehaeuseBillig()[j]); // setzen der Bezeichnungen der Geh�use
											request.setAttribute("m"+i+"b"+j, Info.getArmbandBillig()[j]); // setzen der Bezeichnungen der Armb�nder
									...
									case "Oeko":
										...
										for(int j = 0; j < 3; j++){
											request.setAttribute("m"+i+"c"+j, Info.getGehaeuseOeko()[j]); // setzen der Bezeichnungen der Geh�use
											request.setAttribute("m"+i+"b"+j, Info.getArmbandOeko()[j]); // setzen der Bezeichnungen der Armb�nder
									...
									case "Premium":
										...
										for(int j = 0; j < 3; j++){
											request.setAttribute("m"+i+"c"+j, Info.getGehaeusePremium()[j]); // setzen der Bezeichnungen der Geh�use
											request.setAttribute("m"+i+"b"+j, Info.getArmbandPremium()[j]); // setzen der Bezeichnungen der Armb�nder
	...
	private void setClockClass(HttpServletRequest request, HttpServletResponse response){
		...
		for(int i = 0; i < anzahlUhren; i++){
			...
			if(spieler[spiel.getAktuellerSpieler()].getUhr()[i] != null){
				...
				// Optische Markierung des ausgew�hlten Uhrenteils
				...
				// Markierung des ausgew�hlten Uhrenteils in Inputfeld
