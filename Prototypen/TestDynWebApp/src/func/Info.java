...
public class Info {
	...
	private static String armbandPremium[] = {"Leder","Geh�usematerial","Keramik"};

	private static String uhrwerkBillig[] = {"Quarz","Funk","NochOffen"};
	private static String gehaeuseBillig[] = {"Plastik","Gef�rbtes Plastik","Durchsichtiges Plastik"};
	...
	// Kosten f�r die Entwicklung des Einkaufs
	private static double kostenMarketingBillig[] = { 1000 , 2000 , 3000 };//ben�tigen wir nicht
	private static double kostenMarketingOeko[] = { 1000 , 2000 , 3000 };//ben�tigen wir nicht
	private static double kostenMarketingPremium[] = { 1000 , 2000 , 3000 };//ben�tigen wir nicht
